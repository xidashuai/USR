...
<template>
  <div class="tool">
    ...
    <CanvasToolIcon @click="clickEraser">
    ...
    <CanvasToolIcon @click="clickShapes">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com divcense - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
        <path
    ...
    <CanvasToolIcon @click="clickText">
...
.tool {
  @apply absolute bottom-4 left-1/2 flex -translate-x-1/2 items-center justify-center gap-2 rounded-full bg-gray-200 px-4 py-1 shadow-md;
}
</style>
